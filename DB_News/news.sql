...
-- Dumping structure for table news.article
...
-- Dumping data for table news.article: ~20 rows (approximately)
...
-- Dumping data for table news.category: 10 rows
/*!40000 ALTER TABLE `category` DISABLE KEYS */;
INSERT INTO `category` (`id`, `name`, `status`, `created`, `created_by`, `modified`, `modified_by`, `is_home`, `display`) VALUES
	(1, 'Thể thao', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hoanggiang', 'yes', 'list'),
	(2, 'Giáo dục', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hoanggiang', 'yes', 'grid'),
	(3, 'Sức khỏe', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:33', 'hoanggiang', 'yes', 'list'),
	(4, 'Du lịch', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:30', 'hoanggiang', 'yes', 'grid'),
	(5, 'Khoa học', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hoanggiang', 'no', 'list'),
	(6, 'Số hóa', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:38', 'hoanggiang', 'no', 'grid'),
	(7, 'Xe - Ô tô', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:36', 'hoanggiang', 'no', 'list'),
	(8, 'Kinh doanh', 'active', '2019-05-12 00:00:00', 'hoanggiang', NULL, NULL, 'yes', 'list'),
	(10, 'Test 1', 'active', '2022-08-18 00:00:00', 'HoangGiang', NULL, NULL, 'yes', NULL),
	(11, 'Test 2', 'active', '2022-08-18 00:00:00', 'HoangGiang', '2022-08-18 00:00:00', 'HoangGiang', 'yes', 'grid');
/*!40000 ALTER TABLE `category` ENABLE KEYS */;

-- Dumping structure for table news.slider
...
-- Dumping data for table news.slider: ~3 rows (approximately)
INSERT INTO `slider` (`id`, `name`, `description`, `link`, `thumb`, `created`, `created_by`, `modified`, `modified_by`, `status`) VALUES
	(1, 'Khóa học lập trình Frontend Master', 'Khóa học sẽ giúp bạn trở thành một chuyên gia Frontend với đầy đủ các kiến thức về HTML, CSS, JavaScript, Bootstrap, jQuery, chuyển PSD thành HTML ...', 'https://zendvn.com/khoa-hoc-lap-trinh-frontend-master/', 'rEpDUQCxe4.jpeg', '2019-04-15 00:00:00', 'hoanggiang', '2019-04-24 13:28:03', 'hoanggiang', 'inactive'),
	(2, 'Học lập trình trực tuyến', 'Học trực tuyến giúp bạn tiết kiệm chi phí, thời gian, cập nhật được nhiều kiến thức mới nhanh nhất và hiệu quả nhất', 'https://zendvn.com/', 'K6B1O6UNCb.jpeg', '2019-04-18 00:00:00', 'hoanggiang', '2019-04-24 13:28:06', 'hoanggiang', 'active'),
	(3, 'Ưu đãi học phí', 'Tổng hợp các trương trình ưu đãi học phí hàng tuần, hàng tháng đến tất các các bạn với các mức giảm đặc biệt 50%, 70%,..', 'https://zendvn.com/uu-dai-hoc-phi-tai-zendvn/', 'LWi6hINpXz.jpeg', '2019-04-24 00:00:00', 'hoanggiang', '2019-04-24 13:28:09', NULL, 'active');
...
-- Dumping data for table news.user: ~4 rows (approximately)
INSERT INTO `user` (`id`, `username`, `email`, `fullname`, `password`, `avatar`, `level`, `created`, `created_by`, `modified`, `modified_by`, `status`) VALUES
	(1, 'admin', 'admin@gmail.com', 'admin123456', 'e10adc3949ba59abbe56e057f20f883e', '1ctW8mj8vq.png', 'admin', '2022-08-04 08:00:02', 'admin', '2022-08-04 08:00:20', 'hoanggiang', 'active'),
	(2, 'hailan', 'hailan@gmail.com', 'hailan', '7c6f3ef49405d8a330aaa19ca0d0f6af', '1eSGmvZ3gM.jpeg', 'member', '2022-08-04 08:00:03', 'admin', '2022-08-04 08:00:29', 'hoanggiang', 'active'),
	(3, 'user123', 'test@gmail.com', 'user123', 'e10adc3949ba59abbe56e057f20f883e', 'Hb1QSn1CL8.png', 'member', '2022-08-04 08:00:04', 'admin', '2022-08-04 08:06:33', 'hoanggiang', 'inactive'),
	(4, 'user456', 'user456@gmail.com', 'user456', 'e10adc3949ba59abbe56e057f20f883e', 'J1uknUz0T6.png', 'member', '2022-08-04 08:00:05', 'admin', '2022-08-04 08:02:40', 'hoanggiang', 'inactive');
